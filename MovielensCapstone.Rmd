...
```
                                   ...
                                   Results the modeling results and performance
                                   
We created the model on the training set and evaluate the performance on the test set to evaluating model performance that give us the average 1.060, lambda 0.5 and RMSE 0.857.
